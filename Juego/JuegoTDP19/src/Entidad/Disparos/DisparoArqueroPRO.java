...
public class DisparoArqueroPRO extends Disparo {
    ...
    public DisparoArqueroPRO(Point pos, double velocidad, int damage, Personaje disparador) {
        ...
        imagen[0]=new ImageIcon("src/Sprites/CharacterSprites/Archer/gifs/FlechaPROPrimer.gif");
        imagen[1]=new ImageIcon("src/Sprites/CharacterSprites/Archer/gifs/FlechaPROSegundo.gif");
